"""
═══════════════════════════════════════════════════════════════
PRUEBA 3.3 — Degradación de red durante formación (MASTER, Mac)
═══════════════════════════════════════════════════════════════
...
MISSION_DURATION_S = 260.0   # 4.3 min para 8 condiciones de red        # 60 s de hover cooperativo en formación
...
def main():
    ...
    logger = FlightLogger("test_3_3_master")
