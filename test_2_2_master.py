"""
═══════════════════════════════════════════════════════════════
PRUEBA 2.2 — Formación estática líder-seguidor (MASTER, Mac)
═══════════════════════════════════════════════════════════════
...
MISSION_DURATION_S = 60.0        # 60 s de hover cooperativo en formación
...
def main():
    ...
    logger = FlightLogger("test_2_2_master")
